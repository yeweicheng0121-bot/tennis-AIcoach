...
def compute_fitness_breakdown(workout: dict[str, Any], user_birth_year: Optional[int] = None) -> dict[str, Any]:
    ...
    return {
        ...
        "cardiovascular_endurance": {"score": cardio_score, "avg_hr": avg_hr},
