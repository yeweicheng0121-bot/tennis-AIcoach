...
async def _run_analysis(task, video_id: str, health_workout_id: str | None, user_id: str):
    async with AsyncSessionLocal() as db:
        ...
        task.update_state(state="PROCESSING", meta={"stage": "extracting_frames", "progress": 0.1})
        ...
        task.update_state(state="PROCESSING", meta={
            "stage": "analyzing_frames", "progress": 0.3,
        ...
        for i, batch in enumerate(batches):
            task.update_state(state="PROCESSING", meta={
                "stage": "analyzing_frames", "progress": 0.3 + 0.3 * (i / len(batches)),
